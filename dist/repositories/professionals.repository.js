...
var ProfessionalRepository = /** @class */ (function (_super) {
    ...
    ProfessionalRepository.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        professioal = _a.sent();
                        return [2 /*return*/, professioal];
                }
            });
        });
    };
    ProfessionalRepository = __decorate([
        (0, typeorm_1.EntityRepository)(entities_1.Professional)
    ], ProfessionalRepository);
    return ProfessionalRepository;
}(typeorm_1.Repository));
exports.default = ProfessionalRepository;
//# sourceMappingURL=professionals.repository.js.map