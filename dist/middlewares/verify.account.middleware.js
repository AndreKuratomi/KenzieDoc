    ...
    return __generator(this, function (_a) {
        try {
            ...
            if (userInfo.id !== userId && userInfo.isAdm !== true) {
                throw new errors_1.default("Missing permissions", 401);
            }
            return [2 /*return*/, next()];
        }
        catch (error) {
            return [2 /*return*/, res.status(error.statusCode).json(error.message)];
        }
        return [2 /*return*/];
    });
}); };
exports.default = verifyAccount;
//# sourceMappingURL=verify.account.middleware.js.map