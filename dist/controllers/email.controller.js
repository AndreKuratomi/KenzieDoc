...
var SendEmailController = /** @class */ (function () {
    function SendEmailController() {
    }
    SendEmailController.prototype.handle = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, (0, email_service_1.createMail)(data)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, res.json({ "Status": "Email successfully sent!" })];
                    case 3:
                        error_1 = _a.sent();
                        console.log(error_1);
                        return [3 /*break*/, 4];
